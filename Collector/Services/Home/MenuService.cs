    ...
    public class MenuService
    {
        public List<MateriaisModel> ItensMenu()
        {
            return new List<MateriaisModel>
            {
                ...
                new MateriaisModel { Id=11, Imagem="ic_vidro.png" , Texto="Vidro", Titulo="100% reciclável e dura para sempre preço baixo, poucos lugares reciclam", Descricao="    Vidro quebrado é ainda pior maior número de acidentes com catadores lâmpadas, TVs e espelhos prescisam de atençã0 especial. " },
