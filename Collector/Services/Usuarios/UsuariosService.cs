    ...
    public class UsuariosService
    {
        public async Task<List<UsuarioModel>> UsuariosProximos()
        {
            return  new  List<UsuarioModel>
            {
                ...
                new UsuarioModel { Id = 2 , Nome = "Claudia Oliveira", Apelido = "Isis", Resumo="", Historia="Sou catadora e amo o que faço, e não tem preço ajuda nosso mundo a melhorar", Imagem="fotoPerfil.png", Telefone="(11) 947743825", Cidade = "São Paulo" }
            };
        }
    }
}